...
const Heading: FC<HeadingProps> = ({ number, title_1, title_2}) => {
  return <div className="relative my-10 px-8 z-20">
    ...
    <div className="flex items-center flex-nowrap min-h-min overflow-hidden p-0 w-full font-roboto">
      <p className="text-primary-foreground text-[17vw] lg:text-[12vw] leading-[100%] mr-3">
        {title_1}
      </p>
      <HeadingAnimatedSvg text="LEARN MORE ABOUT OUR FEATURED PROJECTS"/>
      <p className="text-primary-foreground text-[17vw] lg:text-[12vw] leading-[100%] italic">
        {title_2}
      </p>
    </div>
    {/* SVG Curve */}
