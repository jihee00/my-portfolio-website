    ...
    <div className="flex flex-wrap gap-12 min-h justify-start relative">
      ...
      >
        <div className="flex flex-col gap-0.5">
          {/*Title*/}
          <div className="text-primary-foreground break-words whitespace-prewhitespace-pre">
            <p className="leading-6 font-medium text-sm">{title}</p>
          </div>
          {/*SubTitle*/}
          <div className="felx items-center gap-2 w-min whitespace-pre">
            {link ? (
...
const Body: FC<BodyProps> = ({ subTitle, tag, link }) => {
  return <div className="text-secondary-foreground flex items-center">
